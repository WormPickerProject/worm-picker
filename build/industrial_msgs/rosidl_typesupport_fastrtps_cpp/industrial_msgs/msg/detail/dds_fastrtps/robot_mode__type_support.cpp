...
#include "industrial_msgs/msg/detail/robot_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const industrial_msgs::msg::RobotMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  industrial_msgs::msg::RobotMode & ros_message)
{
  // Member: val
  cdr >> ros_message.val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = industrial_msgs::msg::RobotMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const industrial_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<industrial_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
get_message_type_support_handle<industrial_msgs::msg::RobotMode>()
{
  return &industrial_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, industrial_msgs, msg, RobotMode)() {
  return &industrial_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
