...
#include "industrial_msgs/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const industrial_msgs::msg::RobotMode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  industrial_msgs::msg::RobotMode &);
size_t get_serialized_size(
  const industrial_msgs::msg::RobotMode &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const industrial_msgs::msg::TriState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for industrial_msgs::msg::TriState already declared above
...
cdr_serialize(
  const industrial_msgs::msg::RobotStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: mode
  industrial_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.mode,
    cdr);
  // Member: e_stopped
  industrial_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  industrial_msgs::msg::RobotStatus & ros_message)
{
  // Member: header
  ...
  // Member: mode
  industrial_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    industrial_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        industrial_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotMode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: e_stopped
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        industrial_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TriState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = industrial_msgs::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const industrial_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<industrial_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<industrial_msgs::msg::RobotStatus>()
{
  return &industrial_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, industrial_msgs, msg, RobotStatus)() {
  return &industrial_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
