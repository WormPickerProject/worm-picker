...
static const _ReadGroupIO_Request_type_support_symbol_names_t _ReadGroupIO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, ReadGroupIO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, ReadGroupIO_Request)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::ReadGroupIO_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, srv, ReadGroupIO_Request)() {
  return get_message_type_support_handle<motoros2_interfaces::srv::ReadGroupIO_Request>();
}
...
static const _ReadGroupIO_Response_type_support_symbol_names_t _ReadGroupIO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, ReadGroupIO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, ReadGroupIO_Response)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::ReadGroupIO_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, srv, ReadGroupIO_Response)() {
  return get_message_type_support_handle<motoros2_interfaces::srv::ReadGroupIO_Response>();
}
...
static const _ReadGroupIO_type_support_symbol_names_t _ReadGroupIO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, ReadGroupIO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, ReadGroupIO)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::ReadGroupIO_service_type_support_handle;
}
