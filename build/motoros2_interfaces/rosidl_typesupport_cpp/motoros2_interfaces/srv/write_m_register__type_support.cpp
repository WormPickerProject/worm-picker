...
static const _WriteMRegister_Request_type_support_symbol_names_t _WriteMRegister_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, WriteMRegister_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, WriteMRegister_Request)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::WriteMRegister_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, srv, WriteMRegister_Request)() {
  return get_message_type_support_handle<motoros2_interfaces::srv::WriteMRegister_Request>();
}
...
static const _WriteMRegister_Response_type_support_symbol_names_t _WriteMRegister_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, WriteMRegister_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, WriteMRegister_Response)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::WriteMRegister_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motoros2_interfaces, srv, WriteMRegister_Response)() {
  return get_message_type_support_handle<motoros2_interfaces::srv::WriteMRegister_Response>();
}
...
static const _WriteMRegister_type_support_symbol_names_t _WriteMRegister_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motoros2_interfaces, srv, WriteMRegister)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motoros2_interfaces, srv, WriteMRegister)),
  }
};
...
{
  return &::motoros2_interfaces::srv::rosidl_typesupport_cpp::WriteMRegister_service_type_support_handle;
}
