...
: ${AMENT_CURRENT_PREFIX:="/home/logan/worm-picker/install/worm_picker_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/worm_picker_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/worm_picker_moveit_config/environment/path.sh"
