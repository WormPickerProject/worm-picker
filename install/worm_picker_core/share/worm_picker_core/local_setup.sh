...
: ${AMENT_CURRENT_PREFIX:="/home/logan/worm-picker/install/worm_picker_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/worm_picker_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/worm_picker_core/environment/path.sh"
