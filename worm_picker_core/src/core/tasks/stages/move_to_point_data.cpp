...
const geometry_msgs::msg::PoseStamped& MoveToPointData::createPoseGoal(const NodePtr& node) const 
{
...
const geometry_msgs::msg::PoseStamped& MoveToPointData::createPointGoal(const NodePtr& node) const 
{
